...
trial_time:                 longblob@extstorage     # time series of this trial, start from zero for each trial
collision:                  longblob@extstorage     # boolean vector indicating whether the subject hit the maze on each time point
position:                   longblob@extstorage     # 3d recording of the position of the mouse, length equals to interations
velocity:                   longblob@extstorage     # 3d recording of the velocity of the mouse, length equals to interations
sensor_dots:                longblob@extstorage     # raw recordings of the ball
trial_id:                   int                     #
trial_prior_p_left:         float                   # prior probablity of this trial for left
vi_start:                   int                     #
%}

classdef TowersBlockTrials < dj.Part
