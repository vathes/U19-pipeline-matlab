...
---
roi_spatial        :  longblob@mesoimaging  # 2d matrix with image for spatial mask for the roi
...
surround_spatial   :  longblob@mesoimaging  # same as roi_spatial, for the surrounding neuropil ring
%}
