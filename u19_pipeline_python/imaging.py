...
import scanreader
import re
from . import lab, acquisition, imaging
import os
import glob
from os import path
...
class SyncImagingBehavior(dj.Manual): # info in meta imaging
    ...
    -> MotionCorrection
    ---
    frame_behavior_idx:    longblob   # register the sample number of behavior recording to each frame. 1 x nFrames, metadata-imaging-iteration
...
class Segmentation(dj.Imported):
    ...
    -> SegmentationMethod
    """
    key_source = (acquisition.Scan & MotionCorrection) * \
